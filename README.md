...
An ablation is included to quantify the impact of **engineered (derived) features** on performance.

- Results (CSV): `outputs/derived_ablation_results.csv`
- Plot: `outputs/derived_ablation_results.png`
